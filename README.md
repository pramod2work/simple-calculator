...
## Description
Simple Calculator App with skinned tasks to show production build, dev build and unit test related tasks

### Todo
As of now application only supports one operation at a time. Its designed for scalability.
